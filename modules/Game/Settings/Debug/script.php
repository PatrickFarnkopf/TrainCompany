...
script {
	public function __construct() {
		...
		if(isset($options['taskJourneys']) && $options['taskJourneys'] == 'removeAll') $this->removeAllTaskJourneys();
	}
	...
	**/
	...
	/**
	* Alle aktiven Ausschreibungen löschen
	**/
	private function removeAllTaskJourneys() {
		$taskManager = \Game\Task\Journey\i::Manager();
		$taskManager->loadAll();
