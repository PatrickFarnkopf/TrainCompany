...
<button class="Left" onclick="window.location.href='<?= \Core\Module::createModuleLink('Game_Trains_Select',array('taskID'=>\Core\i::Module()->getVarCache('taskID'))) ?>'">
	&laquo; Zurück
</button>
<button class="Right" onclick="sendStations('<?= \Core\Module::createModuleLink(NULL,\Core\i::Module()->getVarCache('mapSendOptions')) ?>')">
